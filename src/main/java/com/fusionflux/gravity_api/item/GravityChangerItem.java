...
public class GravityChangerItem extends Item {
    ...
    public TypedActionResult<ItemStack> use(World world, PlayerEntity user, Hand hand) {
        if(user instanceof ClientPlayerEntity cpe)
            GravityChangerAPI.setDefaultGravityDirectionClient(cpe, gravityDirection, new RotationParameters(), GravityChangerMod.TEST_VERIFIER);
